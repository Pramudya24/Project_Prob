{{-- resources/views/filament/verifikator/rombongan/header-dropdown.blade.php --}}
...
<div class="fi-ta-ctn divide-y divide-gray-200 overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:divide-white/10 dark:bg-gray-900 dark:ring-white/10">
    ...
    <div class="fi-ta-header-ctn divide-y divide-gray-200 dark:divide-white/10">
        ...
        {{-- Peringatan jika belum pilih OPD --}}
        @if (!$opdSelected)
            <div class="px-6 py-4">
                <div class="flex items-center gap-3 rounded-lg bg-danger-50 px-4 py-3 text-sm text-danger-600 dark:bg-danger-400/10 dark:text-danger-400">
                    ...
                    <span class="font-medium">Silahkan pilih OPD terlebih dahulu untuk melihat data rombongan</span>
                </div>
            </div>
        @endif
    </div>

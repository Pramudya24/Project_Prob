...
use App\Filament\Opd\Resources\PengadaanDaruratResource\Pages;
...
class PengadaanDaruratResource extends Resource
{
    protected static ?string $model = PengadaanDarurat::class;
    ...
    {
        return [
            'index' => Pages\ListPengadaanDarurats::route('/'),
            'create' => Pages\CreatePengadaanDarurat::route('/create'),
            'edit' => Pages\EditPengadaanDarurat::route('/{record}/edit'),
        ];
    }
}